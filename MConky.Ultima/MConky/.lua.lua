...
function conky_ring_stats()
	...
	if update_num>5 then
		...
		for i in pairs(settings_t) do
			if settings_t[i]['name'] == "playRing" then
				-- This will open the file
				local filecompletetime = io.popen('python ~/.conky/MConky/completetime.py')
				...
				settings_t[i]['max']=outputcompletetime


				-- This will open the file
				local fileplayPast = io.popen('python ~/.conky/MConky/playPast.py')
				-- This will read all of the output, as always
				...
				settings_t[i]['now']=outputplayPast
...
function draw_image()
    ...
    --/home/mak/.conky/MConky/mark.png
